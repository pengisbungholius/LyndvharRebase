/datum/antagonist/ascendant
	...
	antag_memory = "<b>PSYDON IS DEAD. The Old Pantheon ARE WEAK, and the New Gods ARE FOOLISH. The WORLD IS DYING, AND I AM THE ONLY THING THAT MAY SAVE IT -- THROUGH ANY MEANS NECESSARY.</b>"
